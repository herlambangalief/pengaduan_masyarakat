<?php 
  ...
  if (isset($_POST['add'])) {
    ...
    $level=$_POST['level'];
      ...
      $sql_update="INSERT INTO `petugas` (`id_petugas`, `nama_petugas`, `username`, `password`, `telp`, `level`) VALUES (NULL, '$nama', '$username', '$password', '$telp', '$level');";
      if ($sql_update) {
		...
		<div class="box_general padding_bottom">
			<div class="row">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" required name="telp" placeholder="Nomor Telepon" value="">
              </div>
              <div class="form-group">
                <label>Level</label>
